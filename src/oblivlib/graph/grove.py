...
class Grove:
    def __init__(self,
        ...
        # Initialize the OMAP.
        self._pos_omap = AVLOmapCached(AvlOmapCachedConfig(
            client=client,
            num_data=num_data,
            key_size=key_size,
            data_size=data_size,
        ...
        self._graph_oram = MulPathOram(MulPathOramConfig(
            name="graph",
            client=client,
            num_data=num_data,
            data_size=key_size,
        ...
        self._graph_meta = MulPathOram(MulPathOramConfig(
            name="g_meta",
            client=client,
            num_data=num_data,
            data_size=key_size,
        ...
        self._pos_meta = MulPathOram(MulPathOramConfig(
            name="p_meta",
            client=client,
            num_data=num_data,
            data_size=key_size,
